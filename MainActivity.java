...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Runnable{
    ...
    public void preparaJogo(){
        Carta a1 = new Carta();
        a1.setTag("match1");
        a1.setImg(R.drawable.bacterias90);
        lista.add(a1);
        Carta a2 = new Carta();
        a2.setTag("match1");
        a2.setImg(R.drawable.bacterias90);
        lista.add(a2);

        Carta a3 = new Carta();
        a3.setTag("match2");
        a3.setImg(R.drawable.coracao90);
        lista.add(a3);
        Carta a4 = new Carta();
        a4.setTag("match2");
        a4.setImg(R.drawable.coracao90);
        lista.add(a4);

        Carta a5 = new Carta();
        a5.setTag("match3");
        a5.setImg(R.drawable.dna90);
        lista.add(a5);
        Carta a6 = new Carta();
        a6.setTag("match3");
        a6.setImg(R.drawable.dna90);
        lista.add(a6);

        Carta a7 = new Carta();
        a7.setTag("match4");
        a7.setImg(R.drawable.rim90);
        lista.add(a7);
        Carta a8 = new Carta();
        a8.setTag("match4");
        a8.setImg(R.drawable.rim90);
        lista.add(a8);

        Carta a9 = new Carta();
        a9.setTag("match5");
        a9.setImg(R.drawable.cerebro90);
        lista.add(a9);
        Carta a10 = new Carta();
        a10.setTag("match5");
        a10.setImg(R.drawable.cerebro90);
        lista.add(a10);

        Carta a11 = new Carta();
        a11.setTag("match6");
        a11.setImg(R.drawable.eucarionte90);
        lista.add(a11);
        Carta a12 = new Carta();
        a12.setTag("match6");
        a12.setImg(R.drawable.eucarionte90);
        lista.add(a12);

        Carta a13 = new Carta();
        a13.setTag("match7");
        a13.setImg(R.drawable.procarionte90);
        lista.add(a13);
        Carta a14 = new Carta();
        a14.setTag("match7");
        a14.setImg(R.drawable.procarionte90);
        lista.add(a14);

        Carta a15 = new Carta();
        a15.setTag("match8");
        a15.setImg(R.drawable.figado90);
        lista.add(a15);
        Carta a16 = new Carta();
        a16.setTag("match8");
        a16.setImg(R.drawable.figado90);
        lista.add(a16);
    }
    ...
    public void comparaJogada(ImageButton primeiro, ImageButton segundo){
        if (primeiro.getTag().toString().compareToIgnoreCase(segundo.getTag().toString())==0 && primeiro!=segundo){
            ...
            h.postDelayed(new Runnable() {
                @Override
                public void run() {
                    primeiro.setImageResource(R.drawable.fundo1);
                    segundo.setImageResource(R.drawable.fundo1);
    ...
    @Override
    public void run() {
        b1.setImageResource(R.drawable.fundo1);
        b2.setImageResource(R.drawable.fundo1);
        b3.setImageResource(R.drawable.fundo1);
        b4.setImageResource(R.drawable.fundo1);
        b5.setImageResource(R.drawable.fundo1);
        b6.setImageResource(R.drawable.fundo1);
        b7.setImageResource(R.drawable.fundo1);
        b8.setImageResource(R.drawable.fundo1);
        b9.setImageResource(R.drawable.fundo1);
        b10.setImageResource(R.drawable.fundo1);
        b11.setImageResource(R.drawable.fundo1);
        b12.setImageResource(R.drawable.fundo1);
        b13.setImageResource(R.drawable.fundo1);
        b14.setImageResource(R.drawable.fundo1);
        b15.setImageResource(R.drawable.fundo1);
        b16.setImageResource(R.drawable.fundo1);
        contadorJogada=0;
        destravarBotoes();
    }
